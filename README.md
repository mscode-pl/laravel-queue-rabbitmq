...
======================
[![Latest Stable Version](https://poser.pugx.org/mscodepl/laravel-queue-rabbitmq/v/stable?format=flat-square)](https://packagist.org/packages/mscodepl/laravel-queue-rabbitmq)
[![Build Status](https://github.com/mscode-pl/laravel-queue-rabbitmq/actions/workflows/tests.yml/badge.svg?branch=master)](https://github.com/mscode-pl/laravel-queue-rabbitmq/actions/workflows/tests.yml)
[![Total Downloads](https://poser.pugx.org/mscodepl/laravel-queue-rabbitmq/downloads?format=flat-square)](https://packagist.org/packages/mscodepl/laravel-queue-rabbitmq)
[![License](https://poser.pugx.org/mscodepl/laravel-queue-rabbitmq/license?format=flat-square)](https://packagist.org/packages/mscodepl/laravel-queue-rabbitmq)
...
```
composer require mscode-pl/laravel-queue-rabbitmq
```
